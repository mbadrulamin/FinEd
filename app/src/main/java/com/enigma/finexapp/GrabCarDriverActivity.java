...
public class GrabCarDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grab_driver);
    ...
    private void saveUserInformation() {
        ...
        //Pop up congratulate
        final Dialog dialog = new Dialog(GrabCarDriverActivity.this);
